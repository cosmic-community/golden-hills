...
import { getBlogTagBySlug, getBlogPostsByTag, getBlogTags } from '@/lib/cosmic';
...
export async function generateMetadata({ params }: TagPageProps): Promise<Metadata> {
  ...
  return {
    title: `#${tag.metadata?.name || tag.title} Articles`,
    description: `Articles tagged with ${tag.metadata?.name || tag.title}`,
  };
}
        ...
        <div className="max-w-7xl mx-auto">
          {posts.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-600 text-lg">No articles found with this tag yet.</p>
...
// Blog Post Card Component (same as category page)
